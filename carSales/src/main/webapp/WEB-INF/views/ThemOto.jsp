	...
	<div class="wrapper">
		...
		<div class="body">
			<div class="image-main">
				<img src="images/anh2.jpg" alt="" class="img-body"></img>
			</div>
			<div class="body-main">
				<h3 class="h3-body">Thêm Sản Phẩm</h3>
				<form class="form-main" method="post" modelAttribute="themOto" enctype="multipart/form-data">					
					<div class="row">
					...
					<div class="div-button "><button type="submit"> Thêm Sản Phẩm</button>
				</form>
			</div>
		</div>
	</div> 
