...
@EnableJpaRepositories(basePackages = { "com.nhom1" })  //Repositories la cai chung gian giua entity va table giup chung ket noi dc vs nhau
...
public class JPAConfig{
	...
	@Bean protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.nhom1");
